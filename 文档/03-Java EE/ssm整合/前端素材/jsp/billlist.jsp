...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/jsp/queryBill">
			...
			<select name="queryIsPayment">
			 ...
			 <a href="${pageContext.request.contextPath }/jsp/toBillAdd">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
...
<!--点击删除按钮后弹出的页面-->
<div class="zhezhao" style="background: none;"></div>
